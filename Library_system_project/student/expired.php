...
$var=0;
  ...
  WHERE username='$_SESSION[login_user]'and status='not paid';");
...
if(isset($_POST['submit2']))
{
  ...
  WHERE isseu_book.approve ='$ret' and isseu_book.username='$_SESSION[login_user]' 
...
else if(isset($_POST['submit3']))
{
  $sql="SELECT student.username,roll,books.bid,
    ...
    INNER JOIN isseu_book ON student.username=isseu_book.username 
    INNER JOIN books ON isseu_book.bid=books.bid 
    WHERE isseu_book.approve ='$exp' and isseu_book.username='$_SESSION[login_user]' 
    ORDER BY `isseu_book`.`returnd` DESC";
    $res=mysqli_query($db,$sql);
}
else
{
  ...
  INNER JOIN isseu_book ON student.username=isseu_book.username 
  INNER JOIN books ON isseu_book.bid=books.bid 
  WHERE isseu_book.approve !='' 
  and isseu_book.approve !='yes' and isseu_book.username='$_SESSION[login_user]'  
  ORDER BY `isseu_book`.`returnd` DESC";
  $res=mysqli_query($db,$sql);
}
