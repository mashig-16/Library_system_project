...
<div id="mySidenav" class="sidenav">
  ...
  <div class="h"> <a href="add.php">Add Students</a> </div>
...
<div id="main">
 ...
 <div class="container"  style="text-align: center;">
      <h2 style="color:black; font-family:lucida Console;
      text-align:center"><b>Add New Students</b></h2>
      ...
      <form class="student" action="" method="post">
        ...
        <input type="text" name="contact" class="form-control" 
             placeholder="Contact" required=""><br>
 ...
 <?php
    if(isset($_POST['submit']))
    {
        if(isset($_SESSION['login_user']))
        {
            mysqli_query($db,"INSERT INTO student_infor  VALUES ('','$_POST[stid]','$_POST[first]','$_POST[last]','$_POST[addres]','$_POST[email]','$_POST[contact]','$_POST[department]');");
            ?>
