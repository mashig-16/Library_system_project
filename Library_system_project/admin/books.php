...
<div id="mySidenav" class="sidenav">
  ...
  <div class="h"> <a href="request.php">Book Approve</a> </div>
...
<!--_____________________________ Delete bar _______________-->

<form class="navbar-form" method="post" name="form1">
  
            <input class="form-control" type="text" name="bid" placeholder="Enter Book ID" required="">
            <button style="background-color:#89c6cb;" 
              type="submit" name="submit1" class="btn btn-default">Delete  
            </button>
</form>
</div> <!-- End form div -->
