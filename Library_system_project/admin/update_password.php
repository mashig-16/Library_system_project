...
<head>
    ...
    body
    {
        ...
        height: 650px;
        background-image:url("images/upda.jpg");
        background-size: 1550px 795px;
...
<body>
    ...
    <h1 style="text-align: center; font-size: 30px; font-family: 
      Lucida console;">Change Your Password</h1><br>
    </div> 
